...
<img width="1920" height="1008" alt="image" src="https://github.com/user-attachments/assets/c1712005-72f3-49c1-883d-531293d5676c" />
...
4. Implement Content Security Policy (CSP) to mitigate XSS attacks.
5. Apply proper output encoding before rendering dynamic content in the browser.
6. If using PHP, use secure encoding functions such as:  ```php  htmlspecialchars($input, ENT_QUOTES, 'UTF-8'); ```
